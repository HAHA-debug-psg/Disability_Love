...
<div><div style="background: url(../../image/coverd.png) ">
...
<div style="width: 50%;margin: 0 auto;height: 2000px"id="app">
    <ol>
        <div id="apps">
                ...
                methods:{
                    delete_trend(t_id) {
                        $.ajax({
                            ...
                            success:function(){
                                alert("删除成功！");
                                location.replace("/userTrend/showPage");
                            }
