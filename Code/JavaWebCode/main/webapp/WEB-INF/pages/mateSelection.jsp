...
<div style="background-image: url(../../image/coverd.png)">
    ...
    <h1 style="font-weight: 900; font-family: '宋体';padding-top: 5px;padding-bottom: 1%; color: whitesmoke">择偶标准</h1>
    ...
    <form style="margin: 0 auto;">
        <div class="myRC">
            ...
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'love', '${expect_marital_status}', '');
                    </script>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <script>
                        LevelMenu4('a1|a2|a3|a4|请选择|+${expect_address_province_code}+|+${expect_address_city_code}+|+${expect_address_county_code}',' class="SW SW_area"');
                    </script>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'age', '${expect_age_min}', '');
                    </script>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'ages', '${expect_age_max}', '');
                    </script>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'heigh', '${expect_height_min}', '');
                    </script>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'heighs', '${expect_height_max}', '');
                    </script>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'weigh','${expect_weight_min}', '');
                    </script>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <script>
                        zeai_cn__CreateFormItem('select', 'weighs','${expect_weight_max}', '');
                    </script>
                </dd>
            </dl>
